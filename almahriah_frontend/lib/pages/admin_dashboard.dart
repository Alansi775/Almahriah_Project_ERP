// almahriah_frontend/lib/pages/admin_dashboard.dart
                      ...
                      Container(
                        ...
                        child: QrImageView(
                          ...
                          dataModuleStyle: QrDataModuleStyle(
                            dataModuleShape: QrDataModuleShape.circle, // 💡 تصميم دائري
                            color: Colors.black,
                          ),
                        ),
                      ),
          ...
          children: [
            ...
            if (widget.user.role == 'Admin') ...[
              _buildDrawerItem(
                ...
                Icons.person_add,
                'إضافة مستخدم',
                AddUserPage(user: widget.user),
              ),
              _buildDrawerItem(
                context,
                Icons.manage_accounts,
                'التحكم في المستخدمين',
                ManageUsersPage(user: widget.user),
              ),
              _buildDrawerItem(
                context,
                Icons.task,
              ...
              _buildDrawerItem(
                ...
                'طلبات الإجازة',
                LeaveRequestsPage(user: widget.user),
              ),
              _buildDrawerItem(
                context,
